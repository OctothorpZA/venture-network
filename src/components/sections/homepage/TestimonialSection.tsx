    ...
    <section className="bg-oxfordBlue py-20 md:py-24">
      <div className="container mx-auto px-6 text-center">
        <blockquote className="max-w-4xl mx-auto">
          <p className="text-2xl md:text-4xl font-medium italic text-brand-platinum leading-relaxed">
        ...
        <footer className="mt-8">
          <p className="text-xl font-bold text-brand-platinum">John Doe</p>
          <p className="text-brand-platinum/80">CEO, ExampleCorp</p>
        </footer>
      </div>
    </section>
  );
