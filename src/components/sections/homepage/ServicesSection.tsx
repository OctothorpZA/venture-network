...
const HostingIcon = () => (
  <svg className="w-10 h-10 mb-4 text-shadowBlue" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 12h14M12 5l7 7-7 7" /></svg>
);

const DevelopmentIcon = () => (
  <svg className="w-10 h-10 mb-4 text-shadowBlue" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" /></svg>
);
  ...
  return (
    <section className="bg-white py-20 md:py-24">
      <div className="container mx-auto px-6 text-center">
        ...
        <p className="text-lg md:text-xl text-shadowBlue mt-4 mb-12 max-w-3xl mx-auto">
